	...
	<table>
		...
		<tr>
			...
			<td><select name ="prodi">
				<option>-</option>
				<option value="Sistem Informasi"<?php if($row[3]=='Sistem Informasi'){echo 'selected';}?>>Sistem Informasi</option>
				<option value="MBTI" <?php if($row[3]=='MBTI'){echo 'selected';} ?>>MBTI</option>
				<option value="DKV" <?php if($row[3]=='DKV'){echo 'selected';} ?>>DKV</option>
				<option value="Ilkom" <?php if($row[3]=='Ilkom'){echo 'selected';} ?>>Ilkom</option>
				</select></td>
		</tr>
		<tr>
			<td>Fakultas</td>
